...
Cada componente (cuadro de texto, tablero simple, dado, visor de documentos, carta o mazo) tiene, en la pestaña "Generales" de su modal de configuración, un checkbox "Oculto" (junto a "Bloqueado", "Mostrar tooltip" y "Subir al mover/interactuar", con su propio icono de ayuda), desmarcado por defecto.
