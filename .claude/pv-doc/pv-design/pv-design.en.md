...
**File name and location**: `workflow.<flow-name>.md`, inside the skill's own folder (e.g. `pv-init/workflow.init.md`, `pv-update/workflow.audit.md`, `pv-fix/workflow.fix.md`, `pv-how/workflow.how.md`, `pv-new/workflow.new.md`, `pv-do/workflow.do.md`, `pv-version/workflow.version.md`) — no need to repeat the skill name in the file, the containing folder already indicates it. A skill can have more than one file of this kind if its `SKILL.md` covers several independent entries/flows.
